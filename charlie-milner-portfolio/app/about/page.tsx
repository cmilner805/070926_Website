...
export default function AboutPage() {
  return (
    <div className="mx-auto w-full px-5 pb-20 pt-14 sm:px-8 sm:pb-28 sm:pt-24 lg:px-12">
      ...
      <div className="mt-14 grid gap-8 lg:mt-20 lg:grid-cols-12 lg:gap-10">
        <div className="lg:col-span-4">
          ...
          <div className="mt-5 flex items-center justify-between text-xs uppercase tracking-[0.2em] text-muted-foreground">
            ...
            <span>Avid / Premiere / Resolve</span>
          </div>
        </div>
      ...
      {/* Body copy, magazine two-column spread */}
      ...
      <div className="mt-16 border-t border-border/70 pt-6 lg:mt-24">
