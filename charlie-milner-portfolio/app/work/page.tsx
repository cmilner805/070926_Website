    ...
    <div className="mx-auto w-full max-w-7xl px-5 pb-20 pt-14 sm:px-8 sm:pb-28 sm:pt-24">
      <header className="grid gap-8 lg:grid-cols-[1fr_0.8fr] lg:items-end">
        <div>
          ...
          <h1 className="mt-5 text-balance font-serif text-6xl leading-[0.9] tracking-[-0.04em] sm:text-8xl">My Work</h1>
        </div>
        <p className="max-w-md text-pretty text-base leading-relaxed text-muted-foreground lg:justify-self-end lg:pb-1">
          Documentary, narrative and client films where the edit helps find and shape the story.
        </p>
      </header>
